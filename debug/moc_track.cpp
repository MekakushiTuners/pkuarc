...
QT_MOC_LITERAL(1, 6, 11), // "checksignal"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 6) // "m_type"

    },
    "Track\0checksignal\0\0m_type"
};
...
void Track::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->checksignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Track::checksignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Track::checksignal(int _t1)
{
